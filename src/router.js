      ...
      children: [
        {
          path: 'new',
          name: 'register-new',
          component: () => import('@/views/register/new/Index'),
          meta: { auth: false },
          children: [
            {
              path: 'user',
            ...
            {
              path: 'organisation',
              name: 'register-new-organisation',
              component: () => import('@/views/register/new/Organisation'),
              meta: { auth: false },
            },
            {
              path: 'info',
              name: 'register-new-information',
              component: () => import('@/views/register/new/Information'),
              meta: { auth: false },
            },
            {
              path: 'success',
              name: 'register-new-success',
              component: () => import('@/views/register/new/Success'),
              meta: { auth: false },
            },
          ],
        },
        {
          ...
          component: () => import('@/views/register/existing/Index'),
          meta: { auth: false },
          children: [
            {
              path: 'info',
              name: 'register-existing-information',
            ...
            {
              path: 'success',
              name: 'register-existing-success',
              component: () => import('@/views/register/existing/Success'),
              meta: { auth: false },
            },
          ],
        },
